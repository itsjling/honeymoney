...
PRE_ACCOUNT_BINDING_SOURCE_OCCURRENCE_COLUMNS = [
    *PRE_RATE_METADATA_SOURCE_OCCURRENCE_COLUMNS[:_SOURCE_VALUATION_END],
    "valuation_rate_date",
    "valuation_provider",
    *PRE_RATE_METADATA_SOURCE_OCCURRENCE_COLUMNS[_SOURCE_VALUATION_END:],
]
_SOURCE_ACCOUNT_END = PRE_ACCOUNT_BINDING_SOURCE_OCCURRENCE_COLUMNS.index("account") + 1
SOURCE_OCCURRENCE_COLUMNS = [
    *PRE_ACCOUNT_BINDING_SOURCE_OCCURRENCE_COLUMNS[:_SOURCE_ACCOUNT_END],
    "account_binding_id",
    *PRE_ACCOUNT_BINDING_SOURCE_OCCURRENCE_COLUMNS[_SOURCE_ACCOUNT_END:],
]
...
CATEGORIZED_COLUMNS = [
    ...
    "provenance_status",
    "source_occurrence_count",
    *PRE_ACCOUNT_BINDING_SOURCE_OCCURRENCE_COLUMNS[1:],
]
